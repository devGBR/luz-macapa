<template>
    <v-app id="inspire">
      ...
      <div class="nav-hr w-100"  :style="backgroundBar">
  ...
  left: 5%;" rounded="0">
    ...
    <div class="d-flex w-50 mx-auto" style="margin-left: 5% !important;">
      <v-btn v-for="link in links" :key="link" :href="link.link" variant="text" class="text-nav text-white">
        {{ link.page }}
      </v-btn>
      <button class="ml-1 mr-4 navicon h-100">
      ...
      <div class="side horizontal " style="background: rgb(214, 192, 153) !important; ">
  ...
  "></v-avatar>
          ...
          <div class="w-50 d-flex justify-content-end align-center pr-3">
            <v-btn icon="mdi-magnify" size="100" style="height: 70px; width: 60px; font-size: 8vw;" variant="plain">
      ...
      <div>
        {{ new Date().getFullYear() }} — <strong>Luz Para os Povos Macapá</strong>
      </div>
    </v-footer>
    </v-app>
  </template>
